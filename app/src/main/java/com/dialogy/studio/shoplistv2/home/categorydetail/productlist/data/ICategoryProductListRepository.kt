...
interface ICategoryProductListRepository {
    suspend fun fetchProductList(categoryId: String, page: Int): Call<CategoryProductListResponse?>
}
...
class CategoryProductListRepository @Inject constructor(
    ...
    override suspend fun fetchProductList(categoryId: String, page: Int): Call<CategoryProductListResponse?> =
        service.getProductList(categoryId, page)
